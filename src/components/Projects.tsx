...
export default function Projects() {
  ...
  return (
    <section id="projects" className="relative w-full pt-12 pb-24 px-6 md:px-16 bg-[#0d0d0d] overflow-hidden border-t border-white/5">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          {researchProjects.map((proj, idx) => (
            <motion.div
              ...
              className="group relative flex flex-col justify-between rounded-2xl glass-card p-6 md:p-8 overflow-hidden hover:border-purple-500/30 transition-all duration-300 min-h-[280px]"
            >
              ...
              <div>
                ...
                <div className="relative z-10 mb-6">
                  <span className="text-[11px] font-mono tracking-wider text-purple-300 uppercase block mb-1">
                    {proj.category}
                  </span>
                  <h3 className="text-xl md:text-2xl font-bold text-white tracking-tight group-hover:text-purple-200 transition-colors leading-snug">
                    {proj.title}
                  </h3>
                </div>
              ...
              <div className="relative z-10 mt-8 pt-4 border-t border-white/5 flex items-center justify-between text-xs text-gray-500">
