...
export default function Skills() {
  ...
  return (
    <section id="skills" className="relative w-full pt-12 pb-24 px-4 sm:px-6 md:px-16 bg-[#0d0d0d] overflow-hidden">
      ...
      <div className="max-w-6xl mx-auto relative z-10">
        ...
        <div className="text-center max-w-3xl mx-auto mb-10 sm:mb-14">
          ...
          <p className="text-xs sm:text-sm md:text-base text-gray-400 font-light leading-relaxed max-w-xl mx-auto px-2">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6">
          {exactSkills.map((skill, idx) => (
            <motion.div
              ...
              className="group relative flex flex-col justify-between rounded-2xl glass-card p-5 sm:p-6 md:p-8 min-h-[200px] sm:min-h-[220px] overflow-hidden cursor-default hover:border-purple-500/30 transition-all duration-300"
            >
              ...
              <div className="flex items-center justify-between mb-5 sm:mb-6 relative z-10">
                <div className="p-2.5 sm:p-3 rounded-xl bg-white/5 border border-white/10 group-hover:border-purple-500/30 transition-colors">
                  {skill.icon}
                </div>
              ...
              <div className="relative z-10">
                <span className="text-[10px] sm:text-[11px] font-mono tracking-widest text-purple-400/80 uppercase block mb-1.5 sm:mb-2">
                  {skill.category}
                </span>
                <h3 className="text-base sm:text-lg font-bold text-white leading-snug group-hover:text-purple-200 transition-colors break-words">
                  {skill.name}
                </h3>
              </div>

              {/* Subtle bottom indicator line */}
              <div className="w-0 group-hover:w-full h-[2px] bg-gradient-to-r from-purple-500 to-indigo-500 transition-all duration-500 mt-5 sm:mt-6" />
            </motion.div>
          ))}
        </div>
      </div>
