...
export default function Experience() {
  ...
  return (
    <section id="experience" className="relative w-full pt-12 pb-24 px-6 md:px-16 bg-[#0d0d0d] overflow-hidden border-t border-white/5">
      {/* Centered Ambient Glow Effects */}
      <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[600px] h-[600px] bg-pink-900/10 rounded-full blur-[160px] pointer-events-none" />
        ...
        <div className="flex flex-col gap-8">
          {experiences.map((exp, idx) => (
            <motion.div
              ...
              className="group relative flex flex-col rounded-2xl glass-card p-6 md:p-8 overflow-hidden hover:border-purple-500/30 transition-all duration-300"
            >
              ...
              {/* Header Info */}
              <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 mb-6 relative z-10 pb-6 border-b border-white/5">
                <div>
                  ...
                  <div className="flex flex-wrap items-center gap-3 text-sm text-gray-400 font-medium ml-1">
              ...
              <div className="relative z-10 flex flex-col gap-3.5">
                {exp.points.map((pt, pIdx) => (
                  <div key={pIdx} className="flex items-start gap-3 text-sm text-gray-300 font-light leading-relaxed">
