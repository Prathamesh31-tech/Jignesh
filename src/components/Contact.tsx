...
export default function Contact() {
  ...
  return (
    <section id="contact" className="relative w-full pt-16 pb-12 px-6 md:px-16 bg-[#0a0a0a] overflow-hidden border-t border-white/5">
      {/* Ambient Glow */}
      ...
      <div className="max-w-6xl mx-auto relative z-10">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-start mb-24">
          ...
          <div className="lg:col-span-5 space-y-6">
            <div className="p-6 md:p-8 rounded-2xl glass-card border border-white/5 space-y-6">
              ...
              <div className="space-y-4 pt-2">
                ...
                <a
                  ...
                  className="flex items-center gap-4 p-4 rounded-xl bg-white/[0.02] border border-white/5 hover:border-purple-500/30 hover:bg-white/[0.04] transition-all group"
                >
                  ...
                  <div>
                    <span className="text-[11px] font-mono text-gray-500 uppercase block">Email Address</span>
                ...
                >
                  ...
                  <div>
                    <span className="text-[11px] font-mono text-gray-500 uppercase block">Phone Number</span>
                    <span className="text-sm font-medium text-white group-hover:text-purple-300 transition-colors">
                      +91 8149936059
                    </span>
                  </div>
                ...
                >
                  ...
                  <div>
                    <span className="text-[11px] font-mono text-gray-500 uppercase block">LinkedIn Profile</span>
                    <span className="text-sm font-medium text-white group-hover:text-purple-300 transition-colors">
          ...
          <div className="lg:col-span-7">
            <div className="p-6 md:p-8 rounded-2xl glass-card border border-white/5">
              {submitted ? (
                <div className="text-center py-12 space-y-4">
                  <div className="inline-flex p-4 rounded-full bg-purple-500/10 border border-purple-500/20 text-purple-400 mb-2">
                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                  ...
                  <div>
                    ...
                    <input
                      ...
                      className="w-full px-4 py-3 rounded-xl bg-white/[0.03] border border-white/10 text-white placeholder-gray-600 focus:outline-none focus:border-purple-500 transition-colors text-sm"
                    />
                  </div>
                  ...
                  <div>
                    ...
                    <select
                      ...
                      className="w-full px-4 py-3 rounded-xl bg-[#121212] border border-white/10 text-white focus:outline-none focus:border-purple-500 transition-colors text-sm"
                    >
                  ...
                  <div>
                    ...
                    <textarea
                      ...
                      className="w-full px-4 py-3 rounded-xl bg-white/[0.03] border border-white/10 text-white placeholder-gray-600 focus:outline-none focus:border-purple-500 transition-colors text-sm resize-none"
                    />
                  </div>
